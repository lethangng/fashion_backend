                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Sửa giá</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Nhập giá bán"
                                            id="example-text-input" name="price" value="{{ $product_price->price }}"
                                            required>
                                        @error('price')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Nhập giá niêm yết"
                                            id="example-text-input" name="price_off"
                                            value="{{ $product_price->price_off }}">
                                        @error('price_off')
                                            <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Nhập tiết kiệm"
                                            id="example-text-input" name="sell_off" value="{{ $product_price->sell_off }}">
                                        @error('sell_off')
                                            <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
